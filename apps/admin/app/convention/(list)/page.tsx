    ...
    <main className="py-16 md:w-full">
      ...
      <div className='mx-auto w-4/5'>
        <div className='text-right'>
          <Link className='bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full' href="/convention/add">Add</Link>
        </div>
        ...
        {conventionsResponse.total > 0 && (
          <div className='py-8'>
            <ConventionTable conventions={conventionsResponse.list} total={conventionsResponse.total} />
          </div>
        )}
